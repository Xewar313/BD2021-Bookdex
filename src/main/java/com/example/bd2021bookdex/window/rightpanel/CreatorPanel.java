...
public class CreatorPanel extends JPanel {
    ...
    private void createUser() {
        ...
        modifer.addToDb(new UserEntity(username.getText(), encoder.encode(new String(password))));
        Arrays.fill(password, (char) 0);
    }
    
    private void addTagHandler() {
        ...
        MyButton createdButton = new MyButton("Create");
        createdButton.addActionListener(actionEvent -> createTag());
        prepareButton(createdButton);
    ...
    private void addUserHandler() {
        ...
        MyButton createdButton = new MyButton("Create");
        createdButton.addActionListener(actionEvent -> createUser());
        prepareButton(createdButton);
    }
